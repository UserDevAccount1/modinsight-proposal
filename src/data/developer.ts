...
export const roleSystems: RoleSystem[] = [
  {
    ...
    systemName: 'Full Marketing & Growth Automation Engine',
    description: 'End-to-end growth machine: AI creates social media posts, blog content, email campaigns, and video scripts — then distributes across channels, captures leads, scores them by intent, nurtures through automated sequences, books meetings, tracks conversions, and optimizes the entire funnel with AI analytics.',
    capabilities: [
      'AI-powered social media content creation (LinkedIn, Twitter, Instagram)',
      'Blog content, email campaigns, and video script generation',
      'Multi-channel lead capture funnels (website, social, ads, referral)',
      'Lead scoring with AI-based intent and ICP analysis',
      'Automated nurturing sequences (email, SMS, retargeting ads)',
      'GHL pipeline automation with deal stage tracking',
      'Meeting booking automation with AI follow-up triggers',
      'Conversion analytics dashboard with attribution tracking',
      'A/B testing automation across channels and content types',
    ],
    myExperience: 'Built complete growth automation systems: autonomous content engines with 6 AI agents, lead pipelines that boosted conversion by 45%, and full marketing ecosystems with GHL integration',
  ...
  },
  {
    ...
    systemName: 'Full-Stack HR & Talent Platform',
    description: 'Complete HR system from the ground up: production-grade clock-in/clock-out with mobile app, time tracking, leave management, payroll integration, AI-powered resume screening, automated onboarding, performance reviews, culture surveys, and retention prediction.',
    capabilities: [
      'Full-stack clock-in/clock-out system (web + mobile)',
      'Time tracking, shift scheduling, and leave management',
      'Payroll integration with automated calculations',
      ...
      'Culture surveys with AI sentiment analysis',
    ],
    myExperience: 'Built HR/Employee Dashboard & Analytics at Speech Improvement Center (reduced data access time by 40%), AI Resume Screening automation, and automated onboarding workflows with n8n',
    stack: ['Vue 3', 'Supabase', 'n8n', 'Claude API', 'Python', 'Flutter', 'PWA'],
  },
  {
